...
const Featured = () => {
  ...
  const styles = {
    ...
    cards: `h-full w-50% flex gap-[100px] justify-between mb-[30px] ml-[30px]`,
    ...
    cardCross: `h-[180px] w-[125px] rounded-3xl absolute bottom-[20px] left-[30px] transition-all duration-300 hover:scale-105 flex  overflow-hidden`,
  }
  return (
